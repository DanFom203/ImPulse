...
public class CreateReviewTest {
    ...
    public void testCreateReview() throws Exception {
        ...
        driver.findElement(By.id("datetime")).sendKeys("2025-05-31T12:13");
        driver.findElement(By.id("comment-input")).click();
        driver.findElement(By.id("comment-input")).clear();
        driver.findElement(By.id("comment-input")).sendKeys("Лучший тренер в жизни!");
        driver.findElement(By.xpath("//input[@value='Оставить отзыв']")).click();
    }
